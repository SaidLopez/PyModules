def test_api_module_has_all():
    ...
    from pymodules.contrib.api import __all__ as api_all
...
def test_db_module_has_all():
    ...
    from pymodules.contrib.db import __all__ as db_all
...
def test_messaging_module_has_all():
    ...
    from pymodules.contrib.messaging import __all__ as messaging_all
...
def test_discovery_module_has_all():
    ...
    from pymodules.contrib.discovery import __all__ as discovery_all
